          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div>
              ...
              <p className="text-gray-600">
                캐스트별 매출 분석 및 상위/하위 성과 비교를 확인하세요
              </p>
            </div>
        ...
        {isLoading && (
          ...
          >
            <div className="text-center">
              <div className="w-12 h-12 border-2 border-purple-600 border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>
              <p className="text-gray-600 font-medium text-lg">캐스트별 매출 데이터를 불러오는 중...</p>
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-bold text-gray-900">매출 상위 & 하위 캐스트</h2>
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-bold text-gray-900">전체 캐스트 매출 현황</h2>
          ...
          >
            <div className="text-center space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-all duration-200 font-medium shadow-sm"
              >
                다시 시도
              </motion.button>
            </div>
