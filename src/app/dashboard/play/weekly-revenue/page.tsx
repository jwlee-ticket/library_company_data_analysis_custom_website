        ...
        {isLoading && (
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium text-lg">주간별 매출 데이터를 불러오는 중...</p>
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-bold text-gray-900">유료 점유율 분석</h2>
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-bold text-gray-900">티켓 판매 현황</h2>
          ...
          >
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-bold text-gray-900">매출 금액 분석</h2>
